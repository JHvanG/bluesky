...
NUM_TRANS = 2                   # either 2 or 3 transitions
# NUM_TRANS = 3                   # either 2 or 3 transitions
...
GEN_INTERVAL = 360.0 if NUM_TRANS == 2 else 180.0      # time (seconds) it takes between spawn calls (180 for 3 after one another or 360 for two on equal dist)
