...
EXPERIMENT_NAME = "_ESWtran_{}_{}_{}batch_{}buffer_{}train_{}update_{}spaced_{}alert_{}decay_{}epsilon".format(REWARD_FUNCTION, LOSS_FUNCTION, BATCH_SIZE, BUFFER_SIZE, TRAIN_INTERVAL, TARGET_INTERVAL, GEN_INTERVAL, SEP_REP_HOR, EPSILON_DECAY, MIN_EPSILON).replace(".", "_")
