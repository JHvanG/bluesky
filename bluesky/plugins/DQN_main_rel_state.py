...
EXPERIMENT_NAME = "_random_spawning_two_transitions_360spaced_{}deg_{}nm_{}decay_{}random_chance".format(HDG_CHANGE, SEP_REP_HOR, EPSILON_DECAY, MIN_EPSILON).replace(".", "_")
